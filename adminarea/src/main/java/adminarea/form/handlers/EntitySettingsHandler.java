...
/**
 * Custom form for editing entity-related permissions of an area.
 */
public class EntitySettingsHandler {
    ...
    /**
     * Open the entity settings form for a player with no pre-selected area
     */
    ...
    public void open(Player player, Area area) {
        ...
        try {
            ...
            form.addHandler(FormResponseHandler.withoutPlayer(ignored -> {
                ...
                try {
                    ...
                    if (changedCount > 0) {
                        ...
                        FormUtils.updateAreaAndNotifyPlayer(player, finalArea, changedCount, FormIds.EDIT_AREA, "entity");
                    } else {
                    ...
                    plugin.getLogger().error("Error processing entity settings form", e);
            ...
            plugin.getFormIdMap().put(player.getName(), new adminarea.data.FormTrackingData(
                FormIds.ENTITY_SETTINGS, System.currentTimeMillis()));
