...
/**
 * Custom form for editing technical-related permissions of an area.
 */
public class TechnicalSettingsHandler {
    ...
    /**
     * Open the technical settings form for a player with no pre-selected area
     */
    ...
    public void open(Player player, Area area) {
        ...
        try {
            ...
            form.addHandler(FormResponseHandler.withoutPlayer(ignored -> {
                ...
                try {
                    ...
                    if (changedCount > 0) {
                        ...
                        FormUtils.updateAreaAndNotifyPlayer(player, finalArea, changedCount, FormIds.EDIT_AREA, "technical");
                    } else {
            ...
            plugin.getFormIdMap().put(player.getName(), new adminarea.data.FormTrackingData(
                FormIds.TECHNICAL_SETTINGS, System.currentTimeMillis()));
