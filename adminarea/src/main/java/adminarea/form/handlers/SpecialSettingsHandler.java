...
/**
 * Custom form for editing special permissions of an area.
 */
public class SpecialSettingsHandler {
    ...
    /**
     * Open the special settings form for a player with no pre-selected area
     */
    ...
    public void open(Player player, Area area) {
        ...
        try {
            ...
            form.addHandler(FormResponseHandler.withoutPlayer(ignored -> {
                ...
                try {
                    ...
                    if (changedCount > 0) {
                        ...
                        FormUtils.updateAreaAndNotifyPlayer(player, finalArea, changedCount, FormIds.EDIT_AREA, "special");
                    } else {
                    ...
                    plugin.getLogger().error("Error processing special settings form", e);
            ...
            plugin.getFormIdMap().put(player.getName(), new adminarea.data.FormTrackingData(
                FormIds.SPECIAL_SETTINGS, System.currentTimeMillis()));
